...
function Projects() {
  return (
    <div className="">
      <h1 className="text-3xl font-bold tracking-tight text-center mb-12 md:mb-16 lg:text-4xl">
        Projects
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 md:gap-4 gap-6">
